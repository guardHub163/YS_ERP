...
{
    public class BllHistoryOrderHeaderTable
    {
        public BllHistoryOrderHeaderTable()
        { }
        #region Model
        ...
        private List<BllHistoryOrderLineTable> _items = new List<BllHistoryOrderLineTable>();
        ...
        /// 
        /// </summary>
        public List<BllHistoryOrderLineTable> Items
        {
            get { return _items; }
            set { _items = value; }
        }
        ...
        public void AddItem(BllHistoryOrderLineTable model)
        {
            _items.Add(model);
        }
