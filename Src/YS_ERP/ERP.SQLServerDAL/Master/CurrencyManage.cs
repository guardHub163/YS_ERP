...
namespace CZZD.ERP.SQLServerDAL
{
    public class CurrencyManage:ICurrency
    {
		...
		public bool Exists(string CODE)
		{
			...
			strSql.Append("select count(1) from BASE_CURRENCY");
        ...
        public bool Add(BaseCurrencyTable model)
		{
            ...
            if (Exists(model.CODE))
            {
                ...
                strSql.Append("update BASE_CURRENCY set ");
            ...
            else
            {
                #region 增加
                strSql =new StringBuilder();
			    strSql.Append("insert into BASE_CURRENCY(");
        ...
        public bool Delete(string CODE)
		{
			...
			StringBuilder strSql=new StringBuilder();
            strSql.AppendFormat("update BASE_CURRENCY  set STATUS_FLAG = {0}", CConstant.DELETE);
            strSql.Append(" where CODE=@CODE ");
			SqlParameter[] parameters = {
					new SqlParameter("@CODE", SqlDbType.VarChar,50)};
			parameters[0].Value = CODE;
		...
		{			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 CODE,NAME,STATUS_FLAG,CREATE_USER,CREATE_DATE_TIME,LAST_UPDATE_USER,LAST_UPDATE_TIME from BASE_CURRENCY ");
			strSql.Append(" where CODE=@CODE ");
            ...
            CZZD.ERP.Model.BaseCurrencyTable model = new CZZD.ERP.Model.BaseCurrencyTable();
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM BASE_CURRENCY ");
			if(strWhere.Trim()!="")
			{
        ...
        public DataSet GetList(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.* from BASE_CURRENCY T");
