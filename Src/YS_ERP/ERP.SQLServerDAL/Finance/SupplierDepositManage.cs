...
{
    public class SupplierDepositManage : ISupplierDeposit
    {
        #region 获得当前的最大流水号
        /// <summary>
        /// 获得当前的最大流水号
        ...
        public string GetMaxID()
        {
            ...
            sb.Append(" select max(SLIP_NUMBER) FROM BLL_SUPPLIER_DEPOSIT ");
        ...
        public bool Delete(string slipNumber)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" update BLL_SUPPLIER_DEPOSIT ");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select * from bll_supplier_deposit_view");
            if (strWhere.Trim() != "")
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select count(1) from bll_supplier_deposit_view");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
        ...
        public DataSet GetList(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.* from bll_supplier_deposit_view T");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" SELECT * FROM bll_supplier_deposit_amount_view");
