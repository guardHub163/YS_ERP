...
{
    public class BMasterMachine
    {
        IMasterMachine dal = DALFactory.DataAccess.CreatMasterMachineManage();
        public BMasterMachine()
		{}
		...
		/// 得到一个对象实体
		/// </summary>
        public BaseMasterMachineTable GetModel(string CODE)
		{
