...
{
    public class BProductionProcess
    {
        IProductionProcess dal = DALFactory.DataAccess.CreateProductionProcessManage();
        public BProductionProcess()
        { }
