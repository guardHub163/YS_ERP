...
namespace Czzd.Common.Library
{
    ...
    public class FTPOperate
    {
        ...
        public FTPOperate(string remoteHost, string remotePath, string remoteUser, string remotePass, int remotePort)
        {
        ...
        public void Connect()
        {
            ...
            //IPHostEntry ipHost = Dns.GetHostEntry(RemoteHost);
            //IPEndPoint ep = new IPEndPoint(ipHost.AddressList[0], 21);
